Public Module Variáveis
    ...
    Public listaEntradasAnalogicas As New List(Of String)
    Public listaPWMs As New List(Of String)
    Public RegsInUse As New List(Of String)
    Public BitRegsInUse As New List(Of String)
    Public ControlNames As New List(Of String)
    Public fileResourcesList As New FileVarSystem
