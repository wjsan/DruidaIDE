...
Public Class ComboBoxIconItem
    ...
    'Public Sub New(ByVal text As String, ByVal imageIndex As Integer, ByVal tag As String, ByRef vars As List(Of objVariable))
    '    _text = text
    '    _imageIndex = imageIndex
    '    _tag = tag
    '    varList = vars
    ...
    'Public Sub New(ByVal text As String, ByVal imageIndex As Integer, ByVal tag As String, ByRef vars As List(Of objVariable), descr As String)
    '    _text = text
    '    _imageIndex = imageIndex
    '    _tag = tag
    '    varList = vars
    ...
    'Public Sub New(ByVal text As String, ByVal imageIndex As Integer, ByVal tag As String, ByRef vars As List(Of objVariable), ByRef functions As List(Of objFunction), descr As String)
    '    _text = text
    '    _imageIndex = imageIndex
    '    _tag = tag
    '    varList = vars
    ...
    'Public Sub New(ByVal text As String, ByVal imageIndex As Integer, ByVal tag As String, ByRef vars As List(Of objVariable), ByRef functions As List(Of objFunction), ByRef instances As List(Of objClassInstance), descr As String)
    '    _text = text
    '    _imageIndex = imageIndex
    '    _tag = tag
    '    varList = vars
